...
# Define predictor matrix (X) using selected numeric and categorical features. Excluding the CustomerID columns since it has unique value for each row of the dataset. 
